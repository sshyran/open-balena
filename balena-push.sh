...
--env s3:S3_MINIO_ACCESS_KEY=${OPENBALENA_S3_ACCESS_KEY} \
--env s3:S3_MINIO_SECRET_KEY=${OPENBALENA_S3_SECRET_KEY} \
--env s3:BUCKETS=${OPENBALENA_S3_BUCKETS} \
--env haproxy:BALENA_HAPROXY_CRT=${OPENBALENA_ROOT_CRT} \
--env haproxy:BALENA_HAPROXY_KEY=${OPENBALENA_ROOT_KEY} \
--env haproxy:BALENA_ROOT_CA=${OPENBALENA_ROOT_CA} \
--env haproxy:HAPROXY_HOSTNAME=${OPENBALENA_HOST_NAME} \
--env cert-provider:ACTIVE=${OPENBALENA_ACME_CERT_ENABLED} \
--env cert-provider:DOMAINS="api.${OPENBALENA_HOST_NAME},registry.${OPENBALENA_HOST_NAME},s3.${OPENBALENA_HOST_NAME},vpn.${OPENBALENA_HOST_NAME},tunnel.${OPENBALENA_HOST_NAME}" \
--env cert-provider:TLD=${OPENBALENA_HOST_NAME} 